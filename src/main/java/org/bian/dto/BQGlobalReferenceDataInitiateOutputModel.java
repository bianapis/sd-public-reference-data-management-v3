...
/**
 * BQGlobalReferenceDataInitiateOutputModel
 */
public class BQGlobalReferenceDataInitiateOutputModel   {
  private String globalReferenceDataInstanceReference = null;

  private String globalReferenceDataInitiateActionReference = null;

  private Object globalReferenceDataInitiateActionRecord = null;

  private String globalReferenceDataInstanceStatus = null;
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to the Global Reference Data instance 
   * @return globalReferenceDataInstanceReference
  **/

  public String getGlobalReferenceDataInstanceReference() {
    return globalReferenceDataInstanceReference;
  }

  public void setGlobalReferenceDataInstanceReference(String globalReferenceDataInstanceReference) {
    this.globalReferenceDataInstanceReference = globalReferenceDataInstanceReference;
  }


  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::ISO20022andUNCEFACT::Identifier  general-info: Reference to an Initiate service call 
   * @return globalReferenceDataInitiateActionReference
  **/

  public String getGlobalReferenceDataInitiateActionReference() {
    return globalReferenceDataInitiateActionReference;
  }

  public void setGlobalReferenceDataInitiateActionReference(String globalReferenceDataInitiateActionReference) {
    this.globalReferenceDataInitiateActionReference = globalReferenceDataInitiateActionReference;
  }
  ...
  **/
  ...
  /**
   * `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Text  general-info: The status of the Global Reference Data instance (e.g. initialised, pending, active) 
   * @return globalReferenceDataInstanceStatus
  **/

  public String getGlobalReferenceDataInstanceStatus() {
    return globalReferenceDataInstanceStatus;
  }

  public void setGlobalReferenceDataInstanceStatus(String globalReferenceDataInstanceStatus) {
    this.globalReferenceDataInstanceStatus = globalReferenceDataInstanceStatus;
  }
